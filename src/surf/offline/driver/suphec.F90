...
USE YOEPHY   , ONLY : RTHRFRTI, LEVGEN   ,LESSRO   ,LESN09   ,&
            ...
            &LEFLAKE,LEURBAN,LELAIV ,LEVVCOV ,LEVZ0 ,LECTESSEL, LEAGS, LEAIRCO2COUP, LEFARQUHAR, RLAIINT, & 
...
CALL SUSURF(KSW=NSW,KCSS=NCSS,KCWS=NCWS,KCSNEC=NCSNEC,KSIL=NSIL,KCOM=NCOM,KTILES=NTILES,KTSW=NTSW,KLWEMISS=NLWEMISS,&
    ...
    & LD_LELAIV=LELAIV,LD_LEVVCOV=LEVVCOV,LD_LEVZ0=LEVZ0,LD_LECTESSEL=LECTESSEL,LD_LEAGS=LEAGS,&
