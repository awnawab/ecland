...
DO IST=1,NPOI,NPROMA
  ...
  IST1 = 1
  IEND1 = IEND-IST+1
  CALL SUSDP_DFLT(YDSURF=YSURF,KIDIA=IST1,KFDIA=IEND1,PTVL=VFTVL(IST:IEND),PTVH=VFTVH(IST:IEND),PSLT=VFSOTY(IST:IEND),&
...
DO IST=1,NPOI,NPROMA
  ...
  IST1 = 1
  IEND1 = IEND-IST+1
  CALL SUSDP_DERIV(YDSURF=YSURF,KIDIA=IST1,KFDIA=IEND1,PSLT=VFSOTY(IST:IEND),&
          & PSSDP2=GPD_SDP2(IST:IEND,:),PSSDP3=GPD_SDP3(IST:IEND,:,:),KLEVS3D=NCSS)
ENDDO
!$OMP END PARALLEL DO
