...
SUBROUTINE SUSURF_CTL(KSW,KCSS,KCWS,KCSNEC,KSIL,KCOM,KTILES,KTSW,KLWEMISS,&
 ...
 & LD_LLCCNL,LD_LLCCNO,LD_LEVGEN,LD_LESSRO,LD_LELAIV,LD_LEVVCOV,LD_LEVZ0,&
...
!      LD_LEVVCOV : .T. IF USE LAMBERR-BEER law for Cveg
!      LD_LEVZ0   : .T. IF Z0 is time varying (eg. Raupach 1994)
...
CALL SUSVEG(LD_LELAIV,LD_LEVVCOV,LD_LEVZ0,LD_LECTESSEL,LD_LEAGS,LD_LEFARQUHAR,LD_LEAIRCO2COUP,PRLAIINT,&
