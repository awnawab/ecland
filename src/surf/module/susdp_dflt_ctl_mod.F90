...
INTEGER(KIND=JPIM), ALLOCATABLE :: ITVL(:)
INTEGER(KIND=JPIM), ALLOCATABLE :: ITVH(:)
INTEGER(KIND=JPIM), ALLOCATABLE :: ISLT(:)
...
ALLOCATE(ITVH(SIZE(PTVH)))
ALLOCATE(ITVL(SIZE(PTVL)))
ALLOCATE(ISLT(SIZE(PSLT)))
...
RVAHL2D(:)    = YDAGS%RVAH(ITVL(:))
RVAMMAXH2D(:) = YDAGS%RVAMMAX(ITVH(:))
RVAMMAXL2D(:) = YDAGS%RVAMMAX(ITVL(:))
RVBHL2D(:)    = YDAGS%RVBH(ITVL(:))
RVCEH2D(:)    = YDAGS%RVCE(ITVH(:))
RVCEL2D(:)    = YDAGS%RVCE(ITVL(:))
RVCFH2D(:)    = YDAGS%RVCF(ITVH(:))
RVCFL2D(:)    = YDAGS%RVCF(ITVL(:))
RVCNAH2D(:)   = YDAGS%RVCNA(ITVH(:))
RVCNAL2D(:)   = YDAGS%RVCNA(ITVL(:))
RVDMAXH2D(:)  = YDAGS%RVDMAX(ITVH(:))
RVDMAXL2D(:)  = YDAGS%RVDMAX(ITVL(:))
RVEPSOH2D(:)  = YDAGS%RVEPSO(ITVH(:))
RVEPSOL2D(:)  = YDAGS%RVEPSO(ITVL(:))
RVF2IH2D(:)   = YDAGS%RVF2I(ITVH(:))
RVF2IL2D(:)   = YDAGS%RVF2I(ITVL(:))
RVFZEROSTH2D(:) = YDAGS%RVFZEROST(ITVH(:))
RVFZEROSTL2D(:) = YDAGS%RVFZEROST(ITVL(:))
RVGAMMH2D(:)  = YDAGS%RVGAMM(ITVH(:))
RVGAMML2D(:)  = YDAGS%RVGAMM(ITVL(:))
RVGCH2D(:)    = YDAGS%RVGC(ITVH(:))
RVGCL2D(:)    = YDAGS%RVGC(ITVL(:))
RVGMESH2D(:)  = YDAGS%RVGMES(ITVH(:))
RVGMESL2D(:)  = YDAGS%RVGMES(ITVL(:))
RVLAIMINH2D(:)= YDAGS%RVLAIMIN(ITVH(:))
RVLAIMINL2D(:)= YDAGS%RVLAIMIN(ITVL(:))
RVQDAMMAXH2D(:) = YDAGS%RVQDAMMAX(ITVH(:))
RVQDAMMAXL2D(:) = YDAGS%RVQDAMMAX(ITVL(:))
RVQDGAMMH2D(:) = YDAGS%RVQDGAMM(ITVH(:))
RVQDGAMML2D(:) = YDAGS%RVQDGAMM(ITVL(:))
RVQDGMESH2D(:) = YDAGS%RVQDGMES(ITVH(:))
RVQDGMESL2D(:) = YDAGS%RVQDGMES(ITVL(:))
RVSEFOLDH2D(:) = YDAGS%RVSEFOLD(ITVH(:))
RVSEFOLDL2D(:) = YDAGS%RVSEFOLD(ITVL(:))
RVT1AMMAXH2D(:) = YDAGS%RVT1AMMAX(ITVH(:))
RVT1AMMAXL2D(:) = YDAGS%RVT1AMMAX(ITVL(:))
RVT1GMESH2D(:)  = YDAGS%RVT1GMES(ITVH(:))
RVT1GMESL2D(:)  = YDAGS%RVT1GMES(ITVL(:))
RVT2AMMAXH2D(:) = YDAGS%RVT2AMMAX(ITVH(:))
RVT2AMMAXL2D(:) = YDAGS%RVT2AMMAX(ITVL(:))
RVT2GMESH2D(:)  = YDAGS%RVT2GMES(ITVH(:))
RVT2GMESL2D(:)  = YDAGS%RVT2GMES(ITVL(:))
RVTOPTH2D(:)    = YDAGS%RVTOPT(ITVH(:))
RVTOPTL2D(:)    = YDAGS%RVTOPT(ITVL(:))
RXBOMEGAMH2D(:) = YDAGS%RXBOMEGAM(ITVH(:))
RXBOMEGAML2D(:) = YDAGS%RXBOMEGAM(ITVL(:))
